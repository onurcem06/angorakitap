          ...
          <div className="flex bg-black/40 p-2 gap-1 overflow-x-auto whitespace-nowrap scrollbar-hide border-b border-white/5">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-3 rounded-xl text-[10px] font-black tracking-widest transition-all ${
                  activeTab === tab.id ? 'bg-[#FF8C00] text-white shadow-lg' : 'text-gray-500 hover:bg-white/5'
                }`}
              >
                <tab.icon size={14} />
                {tab.label}
